...
class EmployeeResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
                ...
                'employee_dependents' => json_decode($this->employee_dependents),
                'employee_educational_background' => json_decode($this->employee_educational_background),
                'employee_employment_history' => json_decode($this->employee_employment_history),
                'employee_character_reference' => json_decode($this->employee_character_reference),
