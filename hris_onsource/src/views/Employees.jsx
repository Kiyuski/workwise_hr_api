      ...
      <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
        <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 m-5">
                     <div className="mb-4 flex items-center justify-between">
                        <div>
                           <span className="text-base font-normal text-gray-500">This is a list of Employee</span>
                        </div>
        ...
        <div className="modal-box">
            ...
            <label className="form-control w-full mt-2">
               ...
               <select className="select select-bordered">
                  <option disabled defaultValue>Select here</option>
                  {department.map((de)=>{
                     return <option key={de.id}>{de.department}</option> ;
                  })}
            ...
            <label className="form-control w-full mt-2">
               ...
               <select className="select select-bordered">
                  <option disabled defaultValue>Select here</option>
                  {position.map((pos)=>{
                     return <option key={pos.position_id}>{pos.position}</option> ;
                  })}
               </select>
            </label>
            ...
            <div className="modal-action">
                <button type='submit' onClick={handleSaveImage} className="btn btn-success text-white w-[30%]">Create</button>
